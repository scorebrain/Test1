 ...
 */
package com.electromech.wifirttscan;

import static com.electromech.wifirttscan.AccessPointRangingResultsActivity.SCAN_RESULT_EXTRA;
...
import com.electromech.wifirttscan.MyAdapter.ScanResultClickListener;
        ...
        private List<ScanResult> find80211mcSupportedAccessPoints(
            ...
            for (ScanResult scanResult : originalList) {
                ...
                if (scanResult.is80211mcResponder()) {
                    ...
                    logToUi("Must have found something!");
                }
